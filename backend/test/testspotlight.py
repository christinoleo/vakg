...
print(
    requests.post(
        "http://localhost:8888/knowledge/new_state",
        json=dict(
            graph=dict(id=0),
            va_sequence=dict(
                state=dict(state_data=dict(test=1)),
...
print(
    requests.post(
        ...
        json=dict(
            graph=dict(id=0),
            va_sequence=dict(
                state=dict(state_data=dict(test=2)),
...
print(
    requests.post(
        ...
        json=dict(
            graph=dict(id=0),
            va_sequence=dict(
                state=dict(state_data=dict(test=3)),
...
print(
    requests.post(
        ...
        json=dict(
            graph=dict(id=0),
            u_sequence=dict(
                state=dict(state_data=dict(knowledge=3)),
...
print(
    requests.post(
        ...
        json=dict(
            graph=dict(id=0),
            u_sequence=dict(
                state=dict(state_data=dict(knowledge=30)),
